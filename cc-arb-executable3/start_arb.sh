...
taskset -c '23-31' "$CMD" #This is an example prepared for a Ryzen 7950x CPU with 16 cores and 32 threads — you can adjust these parts according to your own setup.
