...
export JUPITER_URL=http://127.0.0.1:5050
export JUPITER_SWAP_URL=http://127.0.0.1:5050
...
taskset -c '15-23' "$CMD" #This is an example prepared for a Ryzen 7950x CPU with 16 cores and 32 threads — you can adjust these parts according to your own setup.
